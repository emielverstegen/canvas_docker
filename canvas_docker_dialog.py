...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'canvas_docker_dialog_base.ui'))


class CanvasDockerDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(CanvasDockerDialog, self).__init__(parent)
